...
const CRM = () => {
    return (
        <>
            <div className={css.productCRM}>
                <div className={css.leftCRM}>
                    <div>
                        <span>
                    ...
                    <button className={css.crmButton}>
                        Get Started
                    </button>
                </div>


                <div className={css.rightCRM}>
                    <img width="100%" src={crmImage} alt="bitrix screenshot" />
                </div>
            </div>
        </>
